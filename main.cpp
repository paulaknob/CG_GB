...
const char* APP_TITLE = "GB - Amanda Grams e Paula Knob";
...
int main()
{
	...
	while (!glfwWindowShouldClose(gWindow))
	{
		...
		//get x and y position on mouse click
...
//-----------------------------------------------------------------------------
// Is called whenever a mouse is pressed/released via GLFW
//-----------------------------------------------------------------------------

void cursor_position_callback(GLFWwindow* window, double xpos, double ypos)
{
	//std::cout << "cursor moved to " << xpos << " x " << ypos << std::endl;
}
